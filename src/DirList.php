...
class DirList
{
     ...
     */
    public static function scandirRecursive(string $directory, array $include, array $exclude): array  // phpcs:ignore Squiz.Commenting.FunctionComment.IncorrectTypeHint
    {
        ...
        foreach (new \DirectoryIterator($directory) as $file_info) {
            ...
            if ($file_info->isDir()) {
                $res_tmp = self::scandirRecursive($file_info->getRealPath(), $include, $exclude);
