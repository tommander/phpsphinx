...
class PhpDoc
{
     ...
     */
    public static function parseTag(array &$data, string $input, string $tag): string|bool  // phpcs:ignore Squiz.Commenting.FunctionComment.IncorrectTypeHint
    {
        if (
    ...
    public static function parseDocblock(string $docblock): array
    {
        ...
        foreach ($matches as $one_match) {
            ...
            $parse_result = self::parseTag($result['data'], $attrval, $attrname);
     ...
     * @return PhpdocData
     */
    public static function getPhpdocData(string $docblock): array
    {
        ...
        return self::parseDocblock($docblock_2);
    }
}
