...
class Helper
{
     ...
     * @return string
     */
    public static function makeString(mixed $input): string
    {
        if (is_string($input)) {
            return $input;
        }
     ...
     * @return string
     */
    public static function makePath(string ...$path_elements): string
    {
     ...
     * @return string
     */
    public static function fixFilename(string $dirty_filename): string
    {
        return trim(
            preg_replace(
                '/_+/',
