...
class DocblockExtract
{
     ...
     * @return CodeObject
     */
    public static function codeObject(string $type = '', string $name = '', string $docblock = ''): array
    {
        return array(
            'type' => $type,
            'name' => $name,
     ...
     */
    public static function getCodeHierarchy(array $tokens, string &$class_name, string &$last_namespace): array  // phpcs:ignore Squiz.Commenting.FunctionComment.IncorrectTypeHint
    {
        /**
         * Hello.
         *
        ...
        foreach ($tokens as $token) {
            ...
            if (0 === $mode) {
                ...
                $stack[] = self::codeObject('file', '', $token_content);
                $mode = 1;
                continue;
            }
