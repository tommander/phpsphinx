...
final class HelperTest extends BaseTest {
	...
	public function testMakeString(): void {
		...
		$input = null;
		$expected = '';
		$result = Helper::make_string( $input );
	...
	public function testMakePath(): void {
		...
		$result = Helper::make_path( DIRECTORY_SEPARATOR );
		self::assertEquals( $expected, $result, 'test_makepath_3' );

		// 3/ Only dir sep.
		$expected = DIRECTORY_SEPARATOR . 'Hello' . DIRECTORY_SEPARATOR;
		$result = Helper::make_path( DIRECTORY_SEPARATOR . 'Hello' . DIRECTORY_SEPARATOR );
	...
	public function testGetFilename(): void {
		...
		$path = '';
		$expected = '';
		$result = Helper::get_filename( $path );
	...
	public function testRelativePath(): void {
		...
		$expected = '';
		$result = Helper::relative_path( $from, $to, $separator );
